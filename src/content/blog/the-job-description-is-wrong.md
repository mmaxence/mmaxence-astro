---
title: "The Job Description Is Wrong"
...
For context, I've written about where the role is heading. [Designing Above the Interface](https://mmaxence.me/blog/designing-above-the-interface/) on why execution is no longer the scarce thing, and [When the Interface Assembles Itself](https://mmaxence.me/blog/when-the-interface-assembles-itself/) on what the new work actually looks like in an agentic era. This article is the practical consequence of those two. You've redefined the role. Now you have to hire for it.
